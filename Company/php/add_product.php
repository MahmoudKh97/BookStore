...
$query = "INSERT INTO `products`(`CATEGORY`, `SUB_CATEGORY`, `COMPANY`, `NAME`, `PRICE`, `OLD_PRICE`, `DESCRIPTION`, `STATUS`)
		VALUES 
		($category, $sub_category, $company, '$product_name', '$price', '$old_price', '$description', '$status')";
		$link->query($query);
